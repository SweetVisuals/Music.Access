...
const BottomNav: React.FC<BottomNavProps> = ({ onNavigate, currentView }) => {
    ...
    return (
        <div className="lg:hidden fixed bottom-0 left-0 right-0 z-[120] bg-[#050505] px-2 pb-[env(safe-area-inset-bottom)] h-[calc(3.5rem+env(safe-area-inset-bottom))] shadow-none">
