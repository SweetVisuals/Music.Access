  ...
  return (
    <div className="w-full h-[calc(100vh-10rem)] max-w-[1600px] mx-auto pb-4 pt-4 px-4 lg:px-6 animate-in fade-in duration-500 flex flex-col">
        ...
        <div className="flex-1 flex gap-4 lg:gap-6 overflow-hidden">
            {/* Sidebar List */}
            <div className="w-64 lg:w-72 flex flex-col gap-3 overflow-y-auto pr-2 shrink-0 custom-scrollbar">
                <button 
            ...
            {selectedContract ? (
                <div className="flex-1 flex flex-col bg-[#0a0a0a] border border-neutral-800 rounded-xl overflow-hidden">
                    {/* Toolbar */}
                    <div className="h-12 border-b border-white/5 flex items-center justify-between px-4 bg-neutral-900/30 shrink-0">
                    ...
                    <div className="flex-1 flex overflow-hidden">
                        ...
                        <div className="w-64 lg:w-72 border-r border-white/5 p-4 space-y-4 bg-neutral-950 overflow-y-auto custom-scrollbar shrink-0">
                        ...
                        <div className="flex-1 bg-[#111] overflow-y-auto custom-scrollbar relative flex flex-col items-center">
                             ...
                             <div className="pb-16 px-6">
                                 ...
                                 */}
                                 <div className="w-[520px] min-h-[780px] bg-white text-black p-6 shadow-2xl flex flex-col text-[9px] leading-relaxed font-serif relative transition-all">
                                     {/* Header */}
                                     <div className="border-b-2 border-black pb-5 mb-5 flex flex-col items-center justify-center text-center relative">
                                     ...
                                     {/* Signatures */}
                                     <div className="mt-6 pt-6 border-t-2 border-black flex justify-between gap-6 bg-gray-50/50 p-4 -mx-4 -mb-4">
                                         ...
                                         <div className="flex-1">
                                              <div className="h-16 flex items-end justify-center border-b border-black pb-2 mb-2">
