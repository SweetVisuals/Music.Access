        ...
        <div className={`fixed top-[56px] bottom-0 right-0 left-0 lg:left-[260px] z-[150] transition-opacity duration-300 ${isClosing ? 'opacity-0' : 'opacity-100'}`}>
            ...
            <div className={`w-full h-full bg-[#0a0a0a] border-0 flex flex-col lg:flex-row shadow-2xl overflow-hidden relative ${isClosing ? 'animate-slide-out-right' : 'animate-slide-in-right'}`}>
                ...
                <div className="flex-1 flex flex-col border-r border-transparent min-w-0 md:min-w-[50%]">
                    <div className="h-14 md:h-20 border-b border-transparent flex items-center justify-between px-4 md:px-8 bg-neutral-900/30 shrink-0">
                        <div>
                    ...
                    <div className="p-4 md:p-6 border-t border-transparent bg-neutral-900/30 flex justify-between items-center shrink-0">
