        ...
        <div className={`fixed inset-0 z-[1000] transition-opacity duration-300 ${isClosing ? 'opacity-0' : 'opacity-100'}`}>
            ...
            <div className={`w-full h-[100dvh] bg-[#0a0a0a] border-0 flex flex-col shadow-2xl overflow-hidden relative ${isClosing ? 'animate-slide-out-right' : 'animate-slide-in-right'}`}>
                ...
                <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
                    ...
                    {/* LEFT SIDE - FORM */}
                    <div className="flex-1 flex flex-col border-r border-transparent min-w-0 md:min-w-[50%]">
                        <div
                            className="h-14 md:h-20 border-b border-transparent flex items-center justify-between px-4 md:px-8 bg-neutral-900/30 shrink-0"
                            ...
                            <div className="max-w-2xl w-full mx-auto space-y-8">
                                ...
                                <div className="space-y-2 group">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full h-24 md:h-32 bg-neutral-900/50 border border-transparent rounded-xl px-5 py-2.5 md:py-4 text-base md:text-sm text-white focus:border-primary/50 focus:outline-none focus:bg-neutral-900 resize-none transition-all placeholder:text-neutral-700 leading-relaxed"
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex bg-neutral-900 p-1.5 rounded-xl border border-transparent w-full sm:w-2/3">
                                        <button
                                            onClick={() => setServiceData({ ...serviceData, rateType: 'flat' })}
                                            className={`flex-1 flex items-center justify-center gap-2 py-3 text-xs font-bold rounded-lg transition-all ${serviceData.rateType === 'flat' ? 'bg-neutral-800 text-white shadow-lg ring-1 ring-transparent' : 'text-neutral-500 hover:text-white hover:bg-white/5'}`}
                                        >
                                            <Hash size={14} /> Flat Rate
                                        </button>
                                        <button
                                            onClick={() => setServiceData({ ...serviceData, rateType: 'hourly' })}
                                            className={`flex-1 flex items-center justify-center gap-2 py-3 text-xs font-bold rounded-lg transition-all ${serviceData.rateType === 'hourly' ? 'bg-neutral-800 text-white shadow-lg ring-1 ring-transparent' : 'text-neutral-500 hover:text-white hover:bg-white/5'}`}
                                        >
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                placeholder="3"
                                                className="w-full h-12 bg-neutral-900 border border-transparent rounded-xl pl-10 pr-4 text-white font-mono text-sm font-bold focus:border-primary/50 focus:outline-none transition-all placeholder:text-neutral-700"
                                                min="1"
                                            />
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2 pr-2">
                                        {serviceData.features?.length === 0 && (
                                            <div className="text-center py-6 border-2 border-dashed border-transparent rounded-xl text-neutral-600 text-sm">
                                                No features added yet
                                            </div>
                                        )}
                                        {serviceData.features?.map((feature, idx) => (
                                            <div key={idx} className="flex items-center justify-between p-3 pl-4 bg-neutral-900/30 border border-transparent rounded-xl group hover:border-white/10 transition-all animate-in slide-in-from-left-2 duration-300" style={{ animationDelay: `${idx * 50}ms` }}>
                    ...
                    {/* RIGHT SIDE - PREVIEW */}
                    <div className="w-[45%] bg-neutral-950/50 hidden lg:flex flex-col items-center justify-center relative overflow-hidden text-neutral-500">
                        ...
                        <div className="relative z-10 w-full max-w-[340px]">
                            <div className="space-y-4 text-center mb-6">
                                <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-transparent rounded-full">
                ...
                {/* FOOTER - FULL WIDTH */}
                <div
                    className="p-4 md:p-6 border-t border-transparent bg-neutral-900/30 flex justify-between items-center shrink-0 w-full"
