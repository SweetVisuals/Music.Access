    ...
    return (
        <div className={`fixed top-[56px] bottom-0 right-0 left-0 lg:left-[260px] z-[150] transition-opacity duration-300 ${isClosing ? 'opacity-0' : 'opacity-100'}`}>
            ...
            <div className={`w-full h-full bg-[#0a0a0a] border-0 flex flex-col shadow-2xl overflow-hidden relative ${isClosing ? 'animate-slide-out-right' : 'animate-slide-in-right'}`}>
                ...
                <div className="h-14 md:h-16 border-b border-transparent flex items-center justify-between px-4 md:px-8 bg-neutral-900/50 shrink-0">
                ...
                <div className="px-4 md:px-8 pt-6 pb-2 shrink-0">
                    <div className="flex items-center justify-between relative">
                        ...
                        {[1, 2, 3].map((s) => (
                            <div
                                key={s}
                                className={`flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full border transition-all ${step === s ? 'bg-primary text-black border-primary font-bold' : step > s ? 'bg-green-500 text-black border-green-500' : 'bg-neutral-900 text-neutral-500 border-transparent'}`}
                            >
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full h-24 md:h-32 bg-neutral-900 border border-transparent rounded-lg px-4 py-2.5 md:py-3 text-white text-base md:text-sm focus:border-primary/50 focus:outline-none resize-none"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className={`flex flex-wrap gap-2 p-2 border border-transparent rounded-lg bg-neutral-900 overflow-hidden transition-all ${showAllGenres ? 'max-h-[500px]' : 'max-h-[82px]'}`}>
                                            {GENRE_LIST.map(g => (
                                                <button
                                                    key={g}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className={`flex flex-wrap gap-2 p-2 border border-transparent rounded-lg bg-neutral-900 overflow-hidden transition-all ${showAllSubGenres ? 'max-h-[500px]' : 'max-h-[82px]'}`}>
                                            {SUB_GENRES.map(g => (
                                                <button
                                                    key={g}
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="flex flex-wrap items-center gap-2 p-2 bg-neutral-900 border border-transparent rounded-lg min-h-[50px]">
                    ...
                    {step === 2 && (
                        <div className="space-y-6">
                            <div className="flex justify-between items-center">
                                ...
                                <button onClick={addTrack} className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-transparent rounded-lg text-xs font-bold text-white">
                            ...
                            <div className="space-y-3">
                                {tracks.map((track, idx) => (
                                    <div key={idx} className="bg-neutral-900/50 border border-transparent rounded-xl p-4 animate-in slide-in-from-bottom-2">
                                            ...
                                            <div className="flex-1 space-y-4">
                                                <div className="flex gap-4">
                                                    <input
                                                        ...
                                                        className="flex-1 bg-black border border-transparent rounded px-3 py-2 text-white text-base md:text-sm focus:border-primary/50 focus:outline-none"
...
`}
                                ...
                                {tracks.length === 0 && (
                                    <div className="text-center py-12 border-2 border-dashed border-transparent rounded-xl text-neutral-500">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                {projectData.licenses?.map((license, idx) => (
                                    <div key={license.id} className="bg-neutral-900/40 border border-transparent rounded-xl overflow-hidden flex flex-col">
                                        <div className="p-4 border-b border-transparent bg-neutral-900/50 flex justify-between items-center">
                ...
                <div className="h-auto py-4 border-t border-transparent flex flex-col md:flex-row items-center justify-between px-4 md:px-8 bg-neutral-900/50 gap-4 shrink-0 pb-[calc(1rem+env(safe-area-inset-bottom))]">
                ...
                {fileSelectorOpen && (
                    <div className="absolute inset-0 z-50 bg-black/90 flex items-center justify-center p-8 animate-in fade-in duration-100">
                        <div className="bg-[#0a0a0a] border border-transparent rounded-xl w-full max-w-lg shadow-2xl flex flex-col max-h-[500px]">
